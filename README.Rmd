...
This algorithm uses information from a population level list (Reference Data) to built a discrete probability distribution of the target population, which is then used to drive the creation of a representative subsample. ospitals are selected proportionally to the relative weight of the block to which they belong, in term of number of hospitals over the total. The $QS$ is used to weight such representativeness. The weight of the $QS$ itself can be tuned.
