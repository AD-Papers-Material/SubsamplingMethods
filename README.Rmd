...
This algorithm uses information from a population level list (Reference Data) to built a discrete probability distribution of the target population, which is then used to drive the creation of a representative subsample. The hospitals are selected according to how relevant, in term of number of hospitals over the total, is the block they belong to at the country level. **Mia proposta di modifica: the hospitals are selected proportionally to the weight on a country scale of the block to which they belong, in term of...** The $QS$ is used to weight such representativeness. The weight of the $QS$ itself can be tuned.
