...
* the blocks are identified in the Reference Data and for each block $p_{i, country} = Pr(hospital|Region, HSize)$ is computed as the proportion of hospitals in the block over the total;
